...
openwrt-feed/liquid-formula-dpi/files/etc/init.d/fakehttp
openwrt-feed/liquid-formula-dpi/files/etc/init.d/fakesip
openwrt-feed/liquid-formula-dpi/files/etc/init.d/liquid-formula-boot-delay
openwrt-feed/liquid-formula-dpi/files/etc/hotplug.d/iface/99-liquid-formula-dpi
openwrt-feed/liquid-formula-dpi/files/etc/uci-defaults/99-liquid-formula-dpi
openwrt-feed/liquid-formula-dpi/files/usr/share/liquid-formula-dpi/boot-delay-runner.sh
EOF
