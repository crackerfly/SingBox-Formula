...
HOTPLUG="$ROOT/openwrt-feed/liquid-formula-dpi/files/etc/hotplug.d/iface/99-liquid-formula-dpi"
TMP="$(mktemp -d)"
...
LFDPI_COMMON="$ROOT/openwrt-feed/liquid-formula-dpi/files/usr/share/liquid-formula-dpi/service-common.sh"
