...
RUNNER="$ROOT/openwrt-feed/liquid-formula-dpi/files/usr/share/liquid-formula-dpi/boot-delay-runner.sh"
SCHEDULER="$ROOT/openwrt-feed/liquid-formula-dpi/files/etc/init.d/liquid-formula-boot-delay"
TMP="$(mktemp -d)"
