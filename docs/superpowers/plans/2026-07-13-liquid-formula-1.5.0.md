# Liquid Formula 1.5.0 Implementation Plan
...
**Goal:** Ship a source-built `liquid-formula 1.5.0-r1` for OpenWrt 25.12.5 on Linksys E8450 that fixes converter reload/port conflicts and the audited lifecycle, cache, procd, RPC, LuCI, packaging, and upgrade defects while preserving the three user-approved security-sensitive behaviors.
...
- Create: `openwrt-feed/liquid-formula/src/**` from `/tmp/singbox-subscribe-convert-8222509`
- Create: `openwrt-feed/liquid-formula/src/UPSTREAM_COMMIT`
- Create: `openwrt-feed/liquid-formula/src/LICENSES/GPL-3.0-or-later.txt`
...
- [ ] Copy the exact clean upstream tree mechanically into `openwrt-feed/liquid-formula/src/`, excluding only upstream `.git`; add `UPSTREAM_COMMIT` with the full hash and verify `git -C /tmp/singbox-subscribe-convert-8222509 diff --quiet` before the copy.
...
- Modify: `openwrt-feed/liquid-formula/src/cmd/run.go`
- Modify: `openwrt-feed/liquid-formula/src/cmd/run_server.go`
- Create: `openwrt-feed/liquid-formula/src/cmd/server_supervisor.go`
- Create: `openwrt-feed/liquid-formula/src/cmd/run_server_test.go`
- Create: `openwrt-feed/liquid-formula/src/cmd/server_supervisor_test.go`
- Modify: `openwrt-feed/liquid-formula/src/global/config.go`
- Create: `openwrt-feed/liquid-formula/src/global/config_test.go`
- Modify: `openwrt-feed/liquid-formula/src/pkg/safe_close/safe_close.go`
...
- Create: `openwrt-feed/liquid-formula/src/internal/cache/batch.go`
- Create: `openwrt-feed/liquid-formula/src/internal/cache/batch_test.go`
- Create: `openwrt-feed/liquid-formula/src/internal/refresh/manager.go`
- Create: `openwrt-feed/liquid-formula/src/internal/refresh/manager_test.go`
- Modify/Create tests: `openwrt-feed/liquid-formula/src/internal/fetcher/fetcher.go`, `fetcher_test.go`
- Modify/Create tests: `openwrt-feed/liquid-formula/src/internal/handler/handler.go`, `handler_refresh_test.go`
- Modify/Create tests: `openwrt-feed/liquid-formula/src/internal/watcher/watcher.go`, `watcher_test.go`
- Modify/Create tests: `openwrt-feed/liquid-formula/src/global/config.go`, `config_timeout_test.go`
- Modify: `openwrt-feed/liquid-formula/src/cmd/run_server.go`
...
- Modify/Create tests: `openwrt-feed/liquid-formula/src/pkg/logger/logger.go`, `logger_test.go`
- Modify/Create tests: `openwrt-feed/liquid-formula/src/internal/handler/handler.go`, `handler_health_test.go`, `handler_logging_test.go`
- Modify/Create tests: `openwrt-feed/liquid-formula/src/internal/fetcher/fetcher.go`, `fetcher_logging_test.go`
- Modify/Create test: `openwrt-feed/liquid-formula/src/cmd/run_server.go`, `run_server_logging_test.go`
- Modify: `openwrt-feed/liquid-formula/src/go.mod`
- Modify: `openwrt-feed/liquid-formula/src/go.sum`
- Modify: `openwrt-feed/liquid-formula/Makefile`
...
- Modify: `openwrt-feed/liquid-formula/files/usr/share/liquid-formula/validate-template.sh`
- Modify: `openwrt-feed/liquid-formula/files/etc/config/liquid_formula`
- Modify: `openwrt-feed/liquid-formula/files/etc/liquid-formula/config.yaml.example`
...
- Create: `openwrt-feed/liquid-formula/files/usr/share/liquid-formula/run-delayed.sh`
...
- Modify: `openwrt-feed/luci-app-liquid-formula/Makefile`
- Modify: `openwrt-feed/luci-app-liquid-formula/root/usr/share/rpcd/acl.d/luci-app-liquid-formula.json`
...
- [ ] Remove `rpcd-mod-file` and file ACLs; expose only narrow methods. Secure `/var/run/liquid-formula` as root 0700, reject symlinks/wrong ownership, use atomic lock/token/state writes, and strictly parse state/code enums.
...
- Modify: `openwrt-feed/luci-app-liquid-formula/root/www/luci-static/resources/view/liquid-formula/overview.js`
- Modify: `openwrt-feed/luci-app-liquid-formula/po/templates/liquid-formula.pot`
...
- Modify: `openwrt-feed/luci-app-liquid-formula/root/usr/libexec/rpcd/liquid_formula`
- Modify: `openwrt-feed/luci-app-liquid-formula/root/www/luci-static/resources/view/liquid-formula/templates.js`
...
- Create at release time: `dist/liquid-formula-1.5.0-source.zip`
...
- [ ] Run the complete local verification matrix:
  ...
  cd openwrt-feed/liquid-formula/src && go test -race ./...
  ```
