...
EXECUTABLE_PATHS='openwrt-feed/luci-app-liquid-formula/root/usr/libexec/rpcd/liquid_formula
openwrt-feed/liquid-formula/files/etc/init.d/liquid-formula
openwrt-feed/liquid-formula/files/etc/uci-defaults/99-liquid-formula
openwrt-feed/liquid-formula/files/usr/share/liquid-formula/generate-config.sh
openwrt-feed/liquid-formula/files/usr/share/liquid-formula/run-delayed.sh
...
- Create outside Git tree: `dist/liquid-formula-1.5.0-complete-source.zip`
- Create outside Git tree: `dist/liquid-formula-1.5.0-web-upload-batch-1-openwrt-feed.zip`
- Create outside Git tree: `dist/liquid-formula-1.5.0-web-upload-batch-2-repository.zip`
- Remove outside Git tree after replacement verification: `dist/liquid-formula-1.5.0-web-upload.zip`
...
git archive \
	--format=zip \
	--prefix=Liquid-Formula-1.5.0/ \
	--output=/workspace/scratch/dc5edf9fd457/dist/liquid-formula-1.5.0-complete-source.zip \
	HEAD
git archive \
	--format=zip \
	--prefix=Liquid-Formula-1.5.0-web-upload-batch-1/ \
	--output=/workspace/scratch/dc5edf9fd457/dist/liquid-formula-1.5.0-web-upload-batch-1-openwrt-feed.zip \
	HEAD -- openwrt-feed
git archive \
	--format=zip \
	--prefix=Liquid-Formula-1.5.0-web-upload-batch-2/ \
	--output=/workspace/scratch/dc5edf9fd457/dist/liquid-formula-1.5.0-web-upload-batch-2-repository.zip \
...
COMPLETE="$DIST/liquid-formula-1.5.0-complete-source.zip"
BATCH_1="$DIST/liquid-formula-1.5.0-web-upload-batch-1-openwrt-feed.zip"
BATCH_2="$DIST/liquid-formula-1.5.0-web-upload-batch-2-repository.zip"
VERIFY_ROOT=$(mktemp -d "${TMPDIR:-/tmp}/liquid-formula-zip-verify.XXXXXX")
...
zip_paths 'Liquid-Formula-1.5.0/' "$COMPLETE" > "$VERIFY_ROOT/complete"
zip_paths 'Liquid-Formula-1.5.0-web-upload-batch-1/' "$BATCH_1" > "$VERIFY_ROOT/batch-1"
zip_paths 'Liquid-Formula-1.5.0-web-upload-batch-2/' "$BATCH_2" > "$VERIFY_ROOT/batch-2"
...
unzip -p "$COMPLETE" Liquid-Formula-1.5.0/README.md > "$VERIFY_ROOT/README.zip"
...
```sh
rm /workspace/scratch/dc5edf9fd457/dist/liquid-formula-1.5.0-web-upload.zip
test ! -e /workspace/scratch/dc5edf9fd457/dist/liquid-formula-1.5.0-web-upload.zip
